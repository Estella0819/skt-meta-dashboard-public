  ...
  const hierarchy = [
    {
      ...
      children: [
        "底妆合集",
        { name: "粉底棒系列", children: ["粉底棒", "粉底棒2件套"] },
        { name: "气垫系列", children: ["水光气垫", "蓝色气垫", "金色气垫", "气垫合集"] },
        { name: "粉饼系列", children: ["粉饼", "粉饼2件套", "粉饼3件套"] },
    ...
    },
    {
      ...
      children: [
        ...
        { name: "电动眼霜", children: ["电动眼霜"] },
        { name: "红色磨皮精华", children: ["红色磨皮精华"] },
        { name: "护肤套组", children: ["护肤套组"] },
        { name: "VC系列", children: ["VC套组", "VC两件套", "VC双舱精华"] },
        { name: "精华合集", children: ["精华合集"] },
        { name: "神经酰胺系列", children: ["神经酰胺系列"] },
